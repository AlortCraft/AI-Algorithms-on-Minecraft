...
- geometria: quais caixas foram exportadas em cada posicao;
- leitura do ambiente: onde esta o proximo obstaculo para o estado discreto.
...
class Percurso:
    def __init__(self, mapa, z_inicio, z_meta, y_pe=None, nome='?',
                 transformacao=None, mundo=None, recuo_meta=0.0,
        ...
        self.z_meta = z_meta
        self.z_chegada = max(z_inicio, z_meta - float(recuo_meta))
        self.plataforma_meta = plataforma_meta
        ...
        # Mapas novos guardam tambem o nome do bloco. A caixa descreve a
        # geometria; o nome serve para conferir o JSON contra o mundo
        ...
        # Indice por z, que e como o estado discreto consulta.
        self.por_z = {}
    ...
    # Quatro blocos vazios entre os apoios correspondem a cinco posicoes entre
    # seus centros. A frente_3 usa exatamente esse caso. A subida continua
    # limitada separadamente a 1.25 bloco.
    SALTO_ALCANCE = 5
    SALTO_SUBIDA = 1.25
    ...
    def _leva_adiante(self, z, altura, faixa, viaveis):
        ...
        for adiante in range(z + 1, min(z + self.SALTO_ALCANCE, self.z_meta) + 1):
            for altura_destino, faixa_destino in viaveis.get(adiante, []):
                ...
                # vizinha nao passa por cima de nada. A subida ja esta limitada
                # por SALTO_SUBIDA; a frente_3 possui salto longo que sobe um
                # bloco e nao deve ser rejeitado como se fosse uma parede.
    ...
    def posicoes_viaveis(self, z, altura=None):
        ...
        O filtro importa: juntar os niveis faria o estado indicar uma passagem
        que existe tres blocos acima e, portanto, nao pode ser alcancada.
        """
    ...
    def _posicao_de_partida(self):
        ...
        # Nascer no piso, e nao numa faixa que so existe sobre outro bloco.
    ...
    def carregar(cls, caminho_mapa, definicao_trecho):
        ...
        if 'inicio' in definicao_trecho or 'fim' in definicao_trecho:
            ...
            return cls(mapa, z_inicio, z_meta, y_pe,
                       ...
                       definicao_trecho.get('recuo_meta', 0.0),
                       definicao_trecho.get('plataforma_meta'))
        ...
        return cls(mapa,
                   ...
                   recuo_meta=definicao_trecho.get('recuo_meta', 0.0),
                   plataforma_meta=definicao_trecho.get('plataforma_meta'))
